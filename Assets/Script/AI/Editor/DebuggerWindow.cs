...
namespace KBehave
{
    public class DebuggerWindow : EditorWindow
    {
        ...
        [MenuItem("Window/KBehave Debugger")]
        public static void ShowWindow()
        {
            DebuggerWindow window = (DebuggerWindow)EditorWindow.GetWindow(typeof(DebuggerWindow), false, "KBehave Debugger");
            window.Show();
        }
...
//            nodeTextStyle = new GUIStyle(EditorStyles.label);
        ...
        public void OnGUI()
        {
            ...
            GUILayout.Toggle(false, "KBehave Debugger", GUI.skin.FindStyle("LODLevelNotifyText"));
